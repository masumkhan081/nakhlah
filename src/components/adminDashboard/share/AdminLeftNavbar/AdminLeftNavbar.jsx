...
import { adminDashboard } from '@/components/data';
import AdminLeftNavbarSection from '../AdminLeftNavbarSection/AdminLeftNavbarSection';
...
const AdminLeftNavbar = ({ open }) => {
    ...
    return (
        <ScrollArea className={`${open?'bg-white': 'transition duration-500 delay-0 ease-in-out bg-opacity-20'} rounded-xl`}>
