    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <InputField form={form} name={'resetPasswordToken'} placeholder={"Reset Password Token"} type={'password'} style={'admin-input'} level={'Reset Password Token'} levelStyle={'text-[16px]'} />
                <CustomButton
                    txt={'Reset Password'}
                    type="submit"
                    style="admin-btn"
